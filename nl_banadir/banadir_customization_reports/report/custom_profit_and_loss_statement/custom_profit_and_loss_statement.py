...
def get_fiscal_year_data(from_fiscal_year, to_fiscal_year):
	...
	to_fy_dates = frappe.db.get_value("Fiscal Year", to_fiscal_year, ["year_start_date", "year_end_date"], as_dict=True)
	...
	fiscal_year = frappe.db.sql(
		...
		""",
		{"from_start": from_fy_dates["year_start_date"], "to_end": to_fy_dates["year_end_date"]},
		as_dict=1,
	)
