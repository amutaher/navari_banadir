...
def update_sales_documents(sales_docs, item_container_map, total_container_value, total_carton_value):
...
def before_cancel(doc, method):
    if doc.distribute_charges_based_on == "Amount":
        sales_docs, item_container_map, total_container_value, total_carton_value = collect_sales_data(doc)
        item_container_map = update_landed_cost_items(doc, item_container_map, total_container_value)
        update_sales_documents(sales_docs, item_container_map, total_container_value, total_carton_value)
